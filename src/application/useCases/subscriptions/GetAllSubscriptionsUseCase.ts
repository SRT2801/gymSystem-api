...
export class GetAllSubscriptionsUseCase {
  constructor(private subscriptionRepository: IMembershipSubscriptionRepository) {}

  async execute(options?: PaginationOptions): Promise<{ subscriptions: PaginationResult<MembershipSubscription>; isEmpty: boolean }> {
